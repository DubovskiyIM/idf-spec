...
Минимальная нормативная структура слотов (см. [`03-objects/artifact.md`](../03-objects/artifact.md)). Heuristic заполнения слотов в v0.1 не специфицирована полностью — implementer SHOULD использовать analog patterns из catalog/detail/form/dashboard. Conformance не проверяется fixture-вектором.
